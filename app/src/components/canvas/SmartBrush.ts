/**
 * SmartBrush — «умная кисть» для рисования грядок (PLAN9 задача I.2).
 *
 * Дачник рисует грядку пальцем «от руки» — неровный замкнутый контур.
 ...
 * (может быть повёрнут — грядки не всегда параллельны краю участка) и
 * возвращаем его 4 угла. Для людей с низкой точностью пальца это превращает
 * дрожащую петлю в ровную грядку в один жест.
 *
...
/**
 * Главная функция: превращает штрих «от руки» в прямоугольную грядку.
