...
const STEPS: TourStep[] = [
  {
    ...
    text: 'Заведите свой сад или огород — укажите название и размеры. С него начинается всё остальное.',
  },
  {
    icon: '✏️',
    title: 'Нарисуйте схему',
    text: 'Разместите дом, грядки и деревья на плане. Отметьте, где солнце, а где тень — так удобнее планировать посадки.',
  },
  {
    icon: '🌱',
    title: 'Посадите растение',
    text: 'Тапните по грядке и выберите растение из справочника. Дальше — ведите журнал: полив, цветение, урожай.',
  },
];
