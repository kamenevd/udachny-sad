...
const HINTS: Record<Step, HintConfig> = {
  'first-garden': {
    ...
    text: 'Добавьте дом, клумбы, декоративные деревья. Разметьте где солнце, а где тень — потом будете знать, что где сажать.',
    action: 'Понятно!',
  },
  'first-planting': {
    icon: '🌱',
  ...
  'first-event': {
    icon: '📓',
    title: 'Ведите журнал',
    text: 'Записывайте что видите: полив, цветение, обрезка, подкормка. Через годы здесь будет история вашего сада.',
    action: 'Понятно!',
  },
};
